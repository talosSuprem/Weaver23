    ...
    private void checkUserHaveChannel() {
        reference.child("Channels").child(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    Intent intent = new Intent(AccountActivity.this,CryptubeActivity.class);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    String e = snapshot.child("email").getValue().toString();
                     p = snapshot.child("imageurl").getValue().toString();
                    ...
                    try {
                        ...
                        //Picasso.get().load(p).placeholder(R.drawable.ic_person_24).into(user_profile_image);
