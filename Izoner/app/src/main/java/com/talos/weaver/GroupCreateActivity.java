...
public class GroupCreateActivity extends AppCompatActivity {
    ...
    private FloatingActionButton creatGroupButon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        creatGroupButon = findViewById(R.id.createGroupBtn);
        ...
        creatGroupButon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
